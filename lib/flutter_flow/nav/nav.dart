...
// 기능에 필요한 헤더파일 담아둔 헤더파일 모음집
import 'package:mbtitravel/function_manager.dart';

// Provider패키지를 이용한 MBTI 값 전역적으로 저장 헤더파일
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'rottiepage',
          path: '/rottiepage',
          builder: (context, params) => RottiepageWidget(),
        ),
        FFRoute(
          name: 'locationexplainCopy',
          path: '/locationexplainCopy',
          builder: (context, params) => LocationexplainCopyWidget(),
        )
